...
from .image_transforms import create_image_transform, create_image_encoder, create_image_decoder
...
ALGORITHMS = ["flow", "pie", "mf", "gamf", "hybrid", "emf", "pae","dnf_dec"]  # , "dough"
...
def create_model(args, simulator):
    ...
    # PAE for image data
        ...
        model = create_image_pae(args, simulator)
    else:
...
def create_image_dnf_dec(args, c, h, simulator, w):
    ...
    decoder = create_image_decoder(args.modellatentdim,channels_multiplier=15)
...
def create_image_pae(args, simulator):
    logger.info(
    ...
    encoder = create_image_encoder(3, 64, 64, latent_dim=args.modellatentdim, context_features=simulator.parameter_dim() if args.conditionalouter else None,)
    decoder = create_image_decoder(args.modellatentdim,channels_multiplier=20)
    inner_transform = create_vector_transform(
        args.modellatentdim,
        args.innerlayers,
        linear_transform_type=args.lineartransform,
